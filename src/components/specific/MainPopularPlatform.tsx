...
const MainPopularPlatform = () => {
  ...
  const tabStyle =
    'flex h-[40px] w-[105px] sm:h-[60px] sm:w-[160px] md:h-[70px] md:w-[205px] lg:h-[80px] lg:w-[260px] xl:h-[90px] xl:w-[320px] 2xl:h-[100px] 2xl:w-[355px] cursor-pointer items-center justify-center border-b-2 text-xs sm:text-sm md:text-base lg:text-[17px] 2xl:text-[18px]';
  ...
  return (
    <section className='container mx-auto flex flex-col items-center justify-center gap-4 py-24 md:gap-6 xl:gap-8'>
